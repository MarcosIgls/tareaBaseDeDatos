--Listar el login y teléfono de los usuarios con compañía telefónica que no sea 
--TELCEL o IUSACELL

SELECT Usuario, Telefono FROM usuarios WHERE NOT Compania IN ('TELCEL','IUSACELL');
